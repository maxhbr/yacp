...
instance Statemental FoundDependent where
  getRelationFuns (FoundDependent i) =  [\i' -> Relation i' DEPENDENCY_OF i]
...
instance Statemental FoundDependency where
  getRelationFuns (FoundDependency i) =  [\i' -> Relation i DEPENDENCY_OF i']
...
instance Statemental FoundManifestFile where
  getRelationFuns (FoundManifestFile i) =  [\i' -> Relation i DEPENDENCY_MANIFEST_OF i']
